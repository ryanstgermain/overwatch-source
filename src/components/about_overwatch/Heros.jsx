...
const Heros = () => {
  return (
    <div>
      <h2 className='maps-used'>Heroes</h2>
      <Divider hidden />
      <div className='about-overwatch-overview-align'>
        <p className='about-overwatch-overview'>
          There's a hero for everyone. With an empressive list of 31 different heroes, Blizzard 
          ...
          abilities, you will find out that certain heroes don't mix well with others so it's up 
          to you to find the perfect team and fight to victory.
        </p>
        <p className='about-overwatch-overview'>
          You can view all of the heroes that are in game by clicking the button below.
        </p>
      </div>
      <Divider hidden />
